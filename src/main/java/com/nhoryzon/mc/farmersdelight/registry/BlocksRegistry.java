...
public enum BlocksRegistry {
    ...
    JUNGLE_PANTRY("jungle_pantry", () -> new PantryBlock(FabricBlockSettings.copyOf(Blocks.BARREL))),
    ACACIA_PANTRY("acacia_pantry", () -> new PantryBlock(FabricBlockSettings.copyOf(Blocks.BARREL))),
    DARK_OAK_PANTRY("dark_oak_pantry", () -> new PantryBlock(FabricBlockSettings.copyOf(Blocks.BARREL))),
