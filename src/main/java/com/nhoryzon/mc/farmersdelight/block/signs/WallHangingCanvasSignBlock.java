...
public class WallHangingCanvasSignBlock extends WallHangingSignBlock implements ICanvasSign {
    private final DyeColor backgroundColor;

    public WallHangingCanvasSignBlock(@Nullable DyeColor backgroundColor) {
