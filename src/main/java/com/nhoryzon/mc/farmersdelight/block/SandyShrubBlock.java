...
public class SandyShrubBlock extends PlantBlock implements Fertilizable {
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        world.getRegistryManager().get(RegistryKeys.CONFIGURED_FEATURE)
                .getOrEmpty(ConfiguredFeaturesRegistry.PATCH_SANDY_SHRUB_BONEMEAL.identifier())
                .ifPresent(configFeat -> configFeat.generate(world, world.getChunkManager().getChunkGenerator(), random, pos.up()));
    }
